 ...
 * case, the "close POS" button must not redirect to the backend action
 * (portal users can't access it); it should return the user to their
 * "My Account" portal page instead.
 */
